...
import type { BackgroundEvent } from '@fischly-x/shared/src/interfaces/calendar/background-event'
import type { CalendarType } from '@fischly-x/shared/src/interfaces/calendar/calendar-config'
import type { DayBoundariesExternal } from '@fischly-x/shared/src/types/calendar/day-boundaries'
import type { WeekOptions } from '@fischly-x/shared/src/interfaces/calendar/calendar-config'
import type { MonthGridOptions } from '@fischly-x/shared/src/interfaces/calendar/calendar-config'
import {
