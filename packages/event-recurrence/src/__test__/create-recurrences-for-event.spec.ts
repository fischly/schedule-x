    ...
    it('should create recurrences for weekly events', () => {
      const eventWithRRule: CalendarEventExternal = {
        ...
        start: Temporal.ZonedDateTime.from(
          '2024-02-05T10:00:00+01:00[Europe/Berlin]'
        ),
        end: Temporal.ZonedDateTime.from(
          '2024-02-05T11:00:00+01:00[Europe/Berlin]'
        ),
      ...
      const range: DateRange = {
        start: Temporal.ZonedDateTime.from(
          ...
          '2024-02-29T23:59:00+01:00[Europe/Berlin]'
        ),
      }
      ...
      expect(recurrences[0].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-12T10:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[0].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-12T11:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[1].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-19T10:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[1].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-19T11:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[2].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-26T10:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[2].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-26T11:00:00+01:00[Europe/Berlin]')
      )
    })
  ...
  describe('daily events', () => {
    it('should create recurrences for daily events', () => {
      const eventWithRRule: CalendarEventExternal = {
        ...
        title: 'Daily Standup',
        start: Temporal.ZonedDateTime.from(
          '2024-02-05T09:00:00+01:00[Europe/Berlin]'
        ),
        end: Temporal.ZonedDateTime.from(
          '2024-02-05T09:30:00+01:00[Europe/Berlin]'
        ),
      ...
      expect(recurrences[0].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-06T09:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[0].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-06T09:30:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[3].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-09T09:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[3].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-09T09:30:00+01:00[Europe/Berlin]')
      )
    })
  })
})
...
describe('createRecurrencesForBackgroundEvent', () => {
  describe('weekly background events', () => {
    it('should create recurrences for weekly background events', () => {
      ...
      const backgroundEvent: BackgroundEvent = {
        start: Temporal.ZonedDateTime.from(
          '2024-02-05T00:00:00+01:00[Europe/Berlin]'
        ),
        end: Temporal.ZonedDateTime.from(
          '2024-02-05T23:59:00+01:00[Europe/Berlin]'
        ),
        rrule: 'FREQ=WEEKLY;BYDAY=MO;UNTIL=20240226T235959',
        style: {
          backgroundColor: 'red',
      ...
      expect(recurrences).toHaveLength(3)
      expect(recurrences[0].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-12T00:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[0].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-12T23:59:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[0].isCopy).toBe(true)
      expect(recurrences[0].style).toEqual(backgroundEvent.style)
      expect(recurrences[1].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-19T00:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[1].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-19T23:59:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[2].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-26T00:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[2].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-26T23:59:00+01:00[Europe/Berlin]')
      )
    })
  ...
  describe('daily background events', () => {
    it('should create recurrences for daily background events', () => {
      ...
      expect(recurrences).toHaveLength(4)
      expect(recurrences[0].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-06T00:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[0].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-06T23:59:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[3].start).toEqual(
        Temporal.ZonedDateTime.from('2024-02-09T00:00:00+01:00[Europe/Berlin]')
      )
      expect(recurrences[3].end).toEqual(
        Temporal.ZonedDateTime.from('2024-02-09T23:59:00+01:00[Europe/Berlin]')
      )
    })
  })
